                ...
                <div class="col-md-3 pt-0">
                    <div class="list-group list-group-flush account-settings-links">
                        ...
                        <a class="list-group-item list-group-item-action" data-toggle="list"
                           href="#account-change-password">Cập nhật mật khẩu</a>
                        <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-info">Khóa
                            học hiện tại</a>
                        <a class="list-group-item list-group-item-action" data-toggle="list"
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                <p>Số tiền trong ví hiện tại: {{ $user->wallet->amount }}</p>
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="text-right mt-3 ">
                                        <button type="button" class="btn btn-primary save-general save ">Lưu thay đổi
                                        </button>&nbsp;
                                    </div>
                                </div>
